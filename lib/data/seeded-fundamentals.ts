...
export const SEEDED_FUNDAMENTALS: SeededFundamental[] = [
  {
    ...
    subsector: 'Mineração',
    revenue: 198000, ebit: 71000, ebitMargin: 0.358, eps: 6.45, bvps: 49.51,
    ...
    sharesOutstanding: 4439, priceRef: 80.74, marketCapRef: 358420,
  ...
  },
  {
    ...
    revenue: 520000, ebit: 185000, ebitMargin: 0.356, eps: 8.54, bvps: 32.26,
    ...
    sharesOutstanding: 13611, priceRef: 45.67, marketCapRef: 621670,
  ...
  },
  {
    ...
    sector: 'Financeiro',
    subsector: 'Bancos',
    revenue: 163000, ebit: 47270, ebitMargin: 0.29, eps: 4.26, bvps: 19.95,
    ...
    sharesOutstanding: 11095, priceRef: 39.70, marketCapRef: 440540,
